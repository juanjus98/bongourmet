                     ...
                     <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody id="items-especificaciones">
                          ...
                          $detalles_titulo = (!empty($post['detalles']['titulo'])) ? $post['detalles']['titulo'] : '' ;
                          /*$especificaciones_descripcion = $post['especificaciones']['descripcion'];*/
                          $detalles_descripcion = (!empty($post['detalles']['descripcion'])) ? $post['detalles']['descripcion'] : '' ;
                          if (!empty($detalles_titulo)) {
                            foreach ($detalles_titulo as $index => $titulo) {
                              ?>
                              <tr class="row-table-rm">
                                <td><input type="text" name="detalles[titulo][]" class="form-control input-sm" placeholder="Título" value="<?php echo $detalles_titulo[$index]; ?>"></td>
                                <td><input type="text" name="detalles[descripcion][]" class="form-control input-sm" placeholder="Descripción" value="<?php echo $detalles_descripcion[$index]; ?>"></td>
                                <td>
                            ...
                            ?>
                            <tr>
                              <td><input type="text" name="detalles[titulo][]" class="form-control input-sm" placeholder="Título"></td>
                              <td><input type="text" name="detalles[descripcion][]" class="form-control input-sm" placeholder="Descripción"></td>
                              <td>
                                <a href="#" class="btn btn-danger btn-xs btn-quitar-tr">Quitar <span class="glyphicon glyphicon-minus-sign" aria-hidden="true"></span></a>
                              </td>
                            </tr>
